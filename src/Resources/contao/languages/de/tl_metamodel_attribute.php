...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_filter']['1']                = 'Hier können Sie den Filter wählen.';
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_table']['1']                 = 'Bitte wählen Sie die Tabelle, aus der die Werte bezogen werden sollen.';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_table_type']['sql-table']    = 'SQL Tabelle';
