...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_table'][1]        =
    'Please select the source table from where the values shall be retrieved from.';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_column'][0]       = 'Value column';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_column'][1]       =
    'Please select the column where the display text value shall be retrieved from.';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_id'][0]           = 'Id column';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_id'][1]           =
    'Please select the column that shall be used as id';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_alias'][0]        = 'Alias column';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_alias'][1]        =
    'Please select the column that shall be used as option alias (Used in filter widgets i.e.). Select the same as for the id column if unsure.';
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_where'][1]        =
    'The list of options can be limited by using SQL as WHERE condition - use the alias \'sourceTable\' for the source table.';
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['select_filterparams'][1] =
    'Here you can choose a default value for the filter.';
